<div class="container mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <?php else: ?>
      ...
      <div class="mt-6 flex items-center justify-end">
        <a href="<?php echo e(route('checkout.preview')); ?>" class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-md transition duration-200 flex items-center space-x-2">
          <span>Checkout</span>
