 ...
 <body class="bg-gradient-to-r from-green-400 to-blue-500 font-roboto">
   ...
   <div class="max-w-6xl mx-auto flex justify-between items-center px-4">
    ...
    <nav>
     <ul class="flex space-x-4">
      <li>
       <a href="{{ route('dashboard') }}" class="text-gray-700 hover:text-green-700" href="#">
        Home
       </a>
      </li>
      <li>
       <a  href="{{ route('marketdash') }}" class="text-gray-700 hover:text-green-700" href="#">
        Products
       </a>
      </li>
     </ul>
  ...
  <div class="flex flex-col lg:flex-row max-w-6xl mx-auto mt-10 px-4 lg:space-x-8">
   <div class="w-full lg:w-1/2 p-8 bg-white shadow-lg rounded-lg mb-8 lg:mb-0">
    ...
    <form action="{{ route('marketplace.store') }}" class="space-y-8" enctype="multipart/form-data" method="POST" oninput="updatePreview()">
     @csrf
     <div class="mb-6">
